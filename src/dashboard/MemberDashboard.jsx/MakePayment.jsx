    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Payment Form */}
          <motion.div
            className="bg-primary/30 rounded-2xl shadow-lg overflow-hidden border border-secondary/50"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 bg-">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="pl-10 w-full px-4 py-2 border border-secondary/50 rounded-lg focus:outline-none focus:ring-1 focus:ring-secondary/50 focus:border-secondary/50 transition"
                    />
                  </div>
                  <button
                    type="button"
                    onClick={handleApplyCoupon}
                    className="px-4 py-2 rounded-lg bg-primary/80  font-medium hover:bg-secondary/80 hover:text-white transition flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-primary  font-medium hover:bg-secondary/80 hover:text-white  transition flex items-center justify-center gap-2"
                  >
                    <FaEye />
              ...
              <button
                type="submit"
                disabled={submitting}
                className={`mt-8 w-full py-3 bg-primary/80  rounded-lg font-semibold hover:bg-secondary/80 hover:text-white transition flex items-center justify-center gap-2 ${
          ...
          >
            ...
            <div className="p-6">
              <div className="space-y-4 mb-6">
                ...
                {discount > 0 && (
                  <div className="flex justify-between py-2 border-b border-secondary/50 text-green-600">
              ...
              <div className="bg-primary/50 rounded-xl p-4 border border-secondary/50">
              ...
              <div className="mt-6 bg-primary/50 rounded-xl p-4 border border-secondary/50">
  ...
  <div className="space-y-1">
    ...
    <input
      ...
      className={`w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition ${
        props.readOnly ? 'bg-gray-50 text-gray-600' : 'bg-primary/30'
      }`}
    />
  </div>
);
